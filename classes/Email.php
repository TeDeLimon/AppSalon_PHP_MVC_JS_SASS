...
class Email {
    ...
    public function enviarInstrucciones() {
        ...
        $contenido = '<html>';
        $contenido .= "<p><strong>Hola ". $this->nombre. "</strong>. Has solicitado cambiar tu contraseña en App Salón. Haz click en el siguiente enlace para cambiar la contraseña.</p>";
        $contenido .= "<p>Presiona aqui: <a href='http://localhost:300/recuperar?token=".$this->token."'>Cambiar contraseña</a> </p>";
